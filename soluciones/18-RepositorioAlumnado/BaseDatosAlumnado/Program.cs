...
void ListarAlumnos(AlumnosService service, TipoOrdenamiento ordenamiento = TipoOrdenamiento.Dni) {
    Console.WriteLine("\n--- LISTADO DE ALUMNOS ---");
    ...
    var listado = service.GetAllAlumnos(ordenamiento);
...
void MostrarInfoAlumnoPorId(AlumnosService service) {
    ...
    try {
        var alumno = service.GetAlumnoById(id);
...
void MostrarInfoAlumnoPorDni(AlumnosService service) {
    ...
    try {
        var alumno = service.GetAlumnoByDni(dni);
        ImprimirInfoAlumno(alumno);
    }
    catch (KeyNotFoundException ex) {
...
void AnadirNuevoAlumno(AlumnosService service) {
    Console.WriteLine("\n--- AÑADIR NUEVO ALUMNO ---");
    ...
    try {
        service.SaveAlumno(nuevoAlumno);
...
void ActualizarDatosAlumno(AlumnosService service) {
    Console.WriteLine("\n--- ACTUALIZAR ALUMNO ---");
    ...
    try {
        alumnoAntiguo = service.GetAlumnoByDni(dni);
    }
    catch (KeyNotFoundException ex) {
    ...
    if (PedirConfirmacion($"Actualizar el alumno {alumnoAntiguo.NombreCompleto} (ID: {alumnoAntiguo.Id})"))
        ...
        try {
            service.UpdateAlumno(alumnoNuevo);
...
void EliminarAlumnoPorDni(AlumnosService service) {
    Console.WriteLine("\n--- ELIMINAR ALUMNO ---");
    ...
    try {
        ...
        if (PedirConfirmacion(
            ...
            service.DeleteAlumno(alumno.Id);
...
void MostrarEstadisticas(AlumnosService service) {
    ...
    var informe = service.GenerarInforme();
