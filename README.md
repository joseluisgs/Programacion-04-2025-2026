...
- [9. Constructores e inicialización](#9-constructores-e-inicialización)
  ...
  - [9.13 Buenas prácticas en constructores](#913-buenas-prácticas-en-constructores)
...
- [18. Excepciones](#18-excepciones)
  - [18.1 Lanzar excepciones: throw](#181-lanzar-excepciones-throw)
  - [18.2 Manejo: try / catch / finally](#182-manejo-try--catch--finally)
  - [18.3 Excepciones comunes](#183-excepciones-comunes)
  - [18.4 Buenas prácticas](#184-buenas-prácticas)
- [19. Buenas prácticas](#19-buenas-prácticas)
  - [19.1 Nomenclatura y estilo](#191-nomenclatura-y-estilo)
  - [19.2 Mantener clases pequeñas y con responsabilidad única](#192-mantener-clases-pequeñas-y-con-responsabilidad-única)
  - [19.3 Métodos cortos y enfocados](#193-métodos-cortos-y-enfocados)
  - [19.4 Preferir propiedades sobre campos públicos](#194-preferir-propiedades-sobre-campos-públicos)
  - [19.5 Inmutabilidad cuando proceda](#195-inmutabilidad-cuando-proceda)
  - [19.6 Validación temprana](#196-validación-temprana)
  - [19.8 Documentación con XML comments](#198-documentación-con-xml-comments)
  - [19.9 Consideraciones de rendimiento](#199-consideraciones-de-rendimiento)
  - [19.11 Gestión de dependencias y separación de capas](#1911-gestión-de-dependencias-y-separación-de-capas)
- [20. Diferencia entre soluciones, proyectos y namespaces en C#](#20-diferencia-entre-soluciones-proyectos-y-namespaces-en-c)
  - [20.1 Solución (.sln)](#201-solución-sln)
  - [20.2 Proyecto (.csproj)](#202-proyecto-csproj)
  - [20.3 Namespace](#203-namespace)
  - [20.4 Relación práctica](#204-relación-práctica)
  - [20.5 Buenas prácticas](#205-buenas-prácticas)
  - [Autor](#autor)
    - [Contacto](#contacto)
...
## 9.13 Buenas prácticas en constructores
...
## 19.9 Consideraciones de rendimiento
...
## 19.11 Gestión de dependencias y separación de capas

Organiza el código en capas (presentación, lógica, datos), separa los proyectos y usa namespaces claros.

---

# 20. Diferencia entre soluciones, proyectos y namespaces en C#
